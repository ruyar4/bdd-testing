...
Gem::Specification.new do |s|
  ...
  s.summary = "cucumber-3.1.0".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<cucumber-expressions>.freeze, ["~> 5.0.4"])
      ...
      s.add_dependency(%q<cucumber-expressions>.freeze, ["~> 5.0.4"])
